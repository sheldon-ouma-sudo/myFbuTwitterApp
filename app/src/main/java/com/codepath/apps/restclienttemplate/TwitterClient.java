...
public class TwitterClient extends OAuthBaseClient {
  ...
  //when we are publishing a tweet
	public void publishedTweet(String tweetContent, long statusId, JsonHttpResponseHandler handler) {
...
//making a request of the next page of tweet
